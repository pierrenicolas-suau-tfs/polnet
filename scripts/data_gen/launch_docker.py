...
if step == "sample":
    ...
    # Let's complete args
    membranes_list = [os.path.join(root_path, file) for file in membranes_list]
    helix_list = [os.path.join(root_path, file) for file in helix_list]
    proteins_list = [os.path.join(root_path, file) for file in proteins_list]
    mb_proteins_list = [
